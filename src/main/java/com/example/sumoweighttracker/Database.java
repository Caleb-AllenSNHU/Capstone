...
//Date: 10/08/2023
//Author: Caleb Allen
//Comments: Database originally created from template. Has been modified from original template to
//track weights with a timestamp and multiple methods to query data for better user experience
